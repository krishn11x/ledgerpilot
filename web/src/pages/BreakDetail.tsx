...
import { useBreakDetail, useDecideBreak, useInvestigateBreak } from "../hooks";
...
export default function BreakDetail() {
  ...
  const investigate = useInvestigateBreak();
